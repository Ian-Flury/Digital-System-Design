#!/bin/bash
vlib work
vcom -work work -2008 -explicit "./shiftReg_tb.vhd"
vcom -work work -2008 -explicit "./hw6-flury-cpen430.vhd"

# run modelsim simulation and visualize waves 
vsim -gui -voptargs="+acc" work.shiftReg_tb -do ./scripts/waves.do
